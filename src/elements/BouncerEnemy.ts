...
export class BouncerEnemy extends StateMachineLMent {
    ...
    onInit() {
        ...
        this.states = {
            "patrolForward": new BouncerPatrol("patrolForward", this, point1, point2, this.patrolSpeed, this.patrolDelay, this.detectionRadius),
            "patrolBackward": new BouncerPatrol("patrolBackward", this, point2, point1, this.patrolSpeed, this.patrolDelay, this.detectionRadius),
            "chase": new BouncerChase("chase", this, this.chaseSpeed, this.detectionRadius),
            "alert": new BouncerAlert("alert", this, 0, this.detectionRadius, this.alertCooldown)
        }
